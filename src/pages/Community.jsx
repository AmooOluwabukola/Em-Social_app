...
const Community = () => {
  ...
  const getUsers = async () => {
    try {
      ...
      const request = await fetch(
        "https://em-server-3xek.onrender.com/api/v1/users/all"
      );
  ...
  const getCurrentUser = async () => {
    ...
    try {
      const request = await fetch(
        "https://em-server-3xek.onrender.com/api/v1/users",
        {
          headers: {
  ...
  const handleFollow = async (userId) => {
    ...
    try {
      const response = await fetch(
        `https://em-server-3xek.onrender.com/api/v1/users/follow/${userId}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleUnfollow = async (userId) => {
    ...
    try {
      const response = await fetch(
        `https://em-server-3xek.onrender.com/api/v1/users/unfollow/${userId}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
